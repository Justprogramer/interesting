 ...
 * @author: Penger
 * @time: 2019/3/24
 * @description: <p>一个整数二进制中包含多少个1，其中负数用补码表示。
 * </p>
 * @solution: 如果一个整数不为0，那么这个整数至少有一位是1。如果我们把这个整数减1，那么原来处在整数最右边的1就会变为0，
...
public class OneInBinary {
    ...
    public static void main(String[] args) {
        ...
        while (scanner.hasNext()) {
            System.out.println(countOneInBinary(scanner.nextInt()));
        }
    }
}
